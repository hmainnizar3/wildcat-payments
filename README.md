...
- [Scoping](#scoping)
  ...
  - [4. Allow filtering payments per customer 🥅](#4-allow-filtering-payments-per-customer-)
  - [5. Authentication / Authorization](#5-authentication--authorization)
- [First sketch of the architecture 🏰](#first-sketch-of-the-architecture-)
  - [Steps](#steps)
- [Backend 💾](#backend-)
...
#### 4. Allow filtering payments per customer 🥅
...
- ✅ I need some tests as I'm writing the code to prevent any refactoring from silently breaking the essential APIs.
...
I made a short video that is accessible here: [Link to video 🔗](https://www.youtube.com/watch?v=94I7R2Fvre8)
